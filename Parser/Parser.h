...
class Parser
{
	public:
		...
		void Parse();												//main driving function, uses the string passed in from when it was initialised and parses the file by generating a new file with a P after the na,e
	private:
		//Stores number of files inputted
		int fileNum;
