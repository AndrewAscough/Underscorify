...
for      (    int  i      =    0      ;    
i      <    s      .    length      (        )        ;    
i      ++        )        {    if      (        (    s      [    i      ]        >=    48      &&    s      [    i      ]        <=    57      )        ||        (    s      [    i      ]        >=    65      &&    s      [    i      ]        <=    90      )        ||        (    s      [    i      ]        >=    97      &&    s      [    i      ]        <=    122      )        )        {    continue      ;    
    }    else      {    symbol      =    true      ;    
    ...
    }    bool  newLineNeeded      (    std      ::    string  s      )        {    for      (    int  i      =    0      ;    
i      <    s      .    length      (        )        ;    
i      ++        )        {    if      (    s      [    i      ]        ==      ';'  
    )        {    return  true      ;    
    }        }    return  false      ;    
...
for      (    int  i      =    0      ;    
i      <    symbolWord      .    length      (        )        ;    
i      ++        )        {    if      (    isSymbol      (    symbolWord      [    i      ]        )        )        {    if      (    symbolWord      [    i      ]        ==    34      ||    symbolWord      [    i      ]        ==    39      )        {    if      (    isString      %    2      ==    0      )        {    result      +=    symbolWord      [    i      ]        ;    
