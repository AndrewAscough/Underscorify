...
bool isSymbol ( char c )   {  if (   ( c >= 48  &&  c <= 57 )   ||   ( c >= 65  &&  c <= 90 )   ||   ( c >= 97  &&  c <= 122 )  ||  c == 95 )   {  return false ; 
 }  else  {  return true ; 
 }  return false ; 
...
bool isLineComment ( std :: string s )   {  for ( int i = 0 ; i < s . length (  )  ; i ++  ) 
 {  if (  ( s [ i ]   == '/'  &&  s [ i + 1 ]   ==  '/' )  )   {  return true ; 
 }   }  return false ; 
 }  //Searches the string to see if the word contains /* or */
bool isBlockComment ( std :: string s )   {  for ( int i = 0 ; i < s . length (  )  ; i ++  ) 
...
std :: string extractLineComment ( std :: string line )   {  std :: string result ; 
...
std :: string extractBlockComment ( std :: string line )   {  std :: string result ; 
std :: string buffer ; 
for ( int i = 0 ; i < line . length (  )  ; i ++  ) 
...
std :: string nameOutputFile ( std :: string s )   {  for ( int i = 0 ; i < s . length (  )  ; i ++  ) 
 {  if ( s [ i ]   ==  '.' )   {  s . insert ( i , "out" )  ; 
return s ; 
 }   }  s += "out" ; 
return s ; 
 }  int main ( int argc ,  char  * argv [  ]  )   {   	 //Check if there is no filename being given
