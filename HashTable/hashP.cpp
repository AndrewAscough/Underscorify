#include "hash.h"
Hashify :: hashTable :: hashTable (  )   {  inOrder  =  0 ; 
...
void Hashify :: hashTable :: print (  )   {  for ( int i = 0 ; i < tableSize ; i ++  ) 
 {  std :: cout << "#" << i << " " << HashTable [ i ]  -> word  <<  " order: "  <<  HashTable [ i ]  -> order ; 
item  * ptr = HashTable [ i ]  ; 
while ( ptr -> nextItem  !=  NULL )   {  ptr  =  ptr -> nextItem ; 
std :: cout << "|" << ptr -> word  <<  " order: "  <<  ptr -> order ; 
 }  std :: cout << std :: endl ; 
 }   }  //prints the rough distribution of words throughout the buckets
void Hashify :: hashTable :: printDist (  )   {  std :: cout << "number of uniques = "  <<  inOrder  <<  std :: endl ; 
for ( int i = 0 ; i < tableSize ; i ++  ) 
 {  int c = 1 ; 
std :: cout << "#" << i << " " ; 
item  * ptr = HashTable [ i ]  ; 
...
Hashify :: item Hashify :: hashTable :: popEntry (  )   {   	 //Generates blank return val
item returnVal ; 
returnVal . word = "" ; 
returnVal . order =- 1 ; 
...
if ( HashTable [ i ]  -> word  !=  "" )   {   	  	  	 //Entry has no tail
if ( HashTable [ i ]  -> nextItem  ==  NULL )   {  returnVal . word  =  HashTable [ i ]  -> word ; 
returnVal . order  =  HashTable [ i ]  -> order ; 
 }   	  	  	 //Skips to end of tail
else  {  item  * ptr  =  HashTable [ i ]  ; 
while ( ptr -> nextItem  !=  NULL )   {  ptr  =  ptr -> nextItem ; 
...
return returnVal ; 
 ...
 }  bool Hashify :: hashTable :: searchItem ( std :: string s )   {  int index  =  hashCode ( s )  ; 
if ( HashTable [ index ]  -> word  ==  s )   {  return true ; 
 }  item  * ptr  =  HashTable [ index ]  ; 
while ( ptr -> nextItem  !=  NULL )   {  ptr  =  ptr -> nextItem ; 
if ( ptr -> word  ==  s )   {  return true ; 
 }   }  return false ; 
 }  //Returns the order of a certain word. -1 if the word doesnt exist
int Hashify :: hashTable :: getOrder ( std :: string s )   {   	 //Item wasnt found in the hashtable
if (  ! searchItem ( s )  )   {  return  - 1 ; 
 }  int index  =  hashCode ( s )  ; 
if ( HashTable [ index ]  -> word  ==  s )   {  return HashTable [ index ]  -> order ; 
 }  item  * ptr  =  HashTable [ index ]  ; 
while ( ptr -> nextItem  !=  NULL )   {  if ( ptr -> word  ==  s )   {  return ptr -> order ; 
 }  ptr  =  ptr -> nextItem ; 
 }  return ptr -> order ; 
 }  //Adds a unique entry to the hashtable
void Hashify :: hashTable :: addEntry ( std :: string s )   {   	 //If string is already in hash table we dont need to readd it
if ( searchItem ( s )  )   {  return ; 
 }  int index  =  hashCode ( s )  ; 
inOrder ++  ; 
if ( HashTable [ index ]  -> word  ==  "" )   {  HashTable [ index ]  -> word  =  s ; 
HashTable [ index ]  -> order  =  inOrder ; 
 }  else  {  item  * ptr  =  HashTable [ index ]  ; 
 	  	 //generate new entry
item  * entry ; 
entry  =  new item ; 
entry -> word  =  s ; 
...
void Hashify :: hashTable :: deleteTailEntry ( std :: string s )   {   	 //If the item is not in the hashtable, do nothing
if (  ! searchItem ( s )  )   {  return ; 
 }  int index  =  hashCode ( s )  ; 
item  * ptr  =  HashTable [ index ]  ; 
 	 //Tail entry is first entry
if ( ptr -> word  ==  s )   {  ptr -> word  = "" ; 
ptr -> order  =   - 1 ; 
ptr -> nextItem  =  NULL ; 
return ; 
 }   	 //Tail entry is somewhere further in the list
while ( ptr -> nextItem -> nextItem  !=  NULL )   {  ptr  =  ptr -> nextItem ; 
...
int Hashify :: hashTable :: hashCode ( std :: string key )   {  const int p  =  83 ; 
long long hashVal  =  0 ; 
long long power  =  1 ; 
